...
public class Main {
	...
	//private final static Algorithm algorithm = Algorithm.PolicyIteration;
	 final static Algorithm algorithm = Algorithm.QLearning;
	...
	public static void main(String[] args) {
		 ...
		 */
			switch (algorithm) {
				case ValueIteration:
					Analysis analysis1 = new Analysis(PROBLEM + "", "VI", GAMMA);
				...
				case PolicyIteration:
					Analysis analysis2 = new Analysis(PROBLEM + "", "PI", GAMMA);

					runAlgorithm(analysis2, problem, domain, hashingFactory, initialState, new PlannerFactory() {
					...
					break;
				default:
					Analysis analysis3 = new Analysis(PROBLEM + "", "Q", GAMMA);

					runAlgorithm(analysis3, problem, domain, hashingFactory, initialState, new PlannerFactory() {

						@Override
						public Planner createPlanner(int episodeIndex, SADomain domain, HashableStateFactory hashingFactory, SimulatedEnvironment simulatedEnvironment) {
							QLearning agent = new QLearning(domain, GAMMA, hashingFactory, 0.5, 0.1);
...
/**
		...
		numIterationsHashMap.put(Algorithm.QLearning, 1500);
